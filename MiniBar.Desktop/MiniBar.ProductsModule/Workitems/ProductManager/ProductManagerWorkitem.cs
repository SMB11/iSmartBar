...
namespace MiniBar.ProductsModule.Workitems.ProductManager
{
    class ProductManagerWorkitem : ObjectManagerWorkItem<ProductListView, ProductDetailsView>
    {
        ...
        public override void Run()
        {
            ...
            BarCommandManager.RegisterCommand(CommandNames.CancelEditing, CancelCommand);
        ...
        public override void Cleanup()
        {
            ...
            BarCommandManager.UnregisterCommand(CommandNames.CancelEditing, CancelCommand);
        }
