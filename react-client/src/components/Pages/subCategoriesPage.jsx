...
class SubCategoriesPage extends Component {
  ...
  getBrands = () => {
    ...
    this.props.RootCategoryBrandGet(language, parseInt(this.props.match.params.id));
  }
  componentDidMount() {
...
const mapStateToProps = (state, props) => {
  return {
    categoryBrands: rootCategoriesBrandsSelector(state, parseInt(props.match.params.id))
  };
};
