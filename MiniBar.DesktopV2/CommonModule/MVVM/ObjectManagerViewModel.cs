...
{
    public abstract class ObjectManagerViewModel<TList, TDetails> : CrudManagerViewModel, ISupportsListManipulation, IWorkitemAware, IGridViewModel, IObserver<TDetails>
        ...
        where TDetails: IEditableObject, IIdEntityViewModel
    {
        ...
        {
            get { return IsAuthenticated && isDetailsEnabled && !IsObjectLoading; }
        ...
        public SecureAsyncCommand RefreshListCommand
        {
            get
            {
                if (refreshListCommand == null)
                    refreshListCommand = new SecureAsyncCommand(RefreshList, CanRefreshList);
        ...
        public ObjectManagerViewModel()
        {
            ...
            WhenCurrentItemChanged.Subscribe(HandleCurrentItemChanged);
