    ...
    public class ImportViewModel : BaseViewModel
    {
        ...
        async Task ExecuteSaveTemplateCommand()
        {
            ...
            if (folderDialog.ShowDialog() == System.Windows.Forms.DialogResult.OK)
            {
                ...
                await Task.Run(() =>
                {
                    ...
                    {
                        UIHelper.Error("Unauthorized to access the specified folder");
                        return;
                    }
                    if (UIHelper.ShowMessageBox("Open the saved file?", "Open Template", System.Windows.MessageBoxButton.YesNo) == System.Windows.MessageBoxResult.Yes)
        ...
        void OpenExcelFile(string filename)
        {
            ...
            catch
            {
                ...
                UIHelper.Error("Failed to open file.");
            }
        }
