    ...
    public class GridProperties
    {
        ...
        private static void GenerateColumns(GridControl grid)
        {
            ...
            foreach (GridColumnAttribute columnAttribute in columns)
            {
                ...
                //switch (columnAttribute.EditorType)
                //{
                //    case GridColumnEditorType.LookUpEdit:
                //        LookUpEditSettings lookUpEditSettings = new LookUpEditSettings();
                //        lookUpEditSettings.Name = "lookUpEditGrid1";
                //        lookUpEditSettings.ItemsSource = new List<string>() { "123", "2" };
                //        column.EditSettings = lookUpEditSettings;
                //        break;
                //}
